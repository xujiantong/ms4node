        ...
        <div>
            <el-form
                ...
                <el-form-item class="btnRight">
                    <el-button v-if="user.identity == 'manage'" type="primary" size ="small" icon="view" @click='onAddMoney()'>添加</el-button>
                </el-form-item>
            </el-form>
        </div>
            ...
            <el-table
                ...
                <el-table-column
                    ...
                    <template slot-scope="scope">
                        ...
                        <span style="margin-left: 10px">{{ scope.row.date | timeTrans }}</span>
                    </template>
                </el-table-column>
                <el-table-column
                        prop="type"
